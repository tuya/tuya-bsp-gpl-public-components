...
#define QMI8658_ACCDATA_READY			(0x01)
#define QMI8658_GYRODATA_READY			(0x02)
#define QMI8658_ACCGYRO_READY			(QMI8658_ACCDATA_READY | QMI8658_ACCDATA_READY)
