...
* *********************************************************/
BYTE CMT2300A_ReadReg(BYTE addr)
{
    BYTE dat = 0xFF;
...
*          dat: register value
* *********************************************************/
void CMT2300A_WriteReg(BYTE addr, BYTE dat)
{
...
* *********************************************************/
void CMT2300A_ReadFifo(BYTE buf[], WORD len)
{
...
* *********************************************************/
void CMT2300A_WriteFifo(const BYTE buf[], WORD len)
{
