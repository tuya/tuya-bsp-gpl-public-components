...
void nolock_dm_set_md_type(struct mapped_device *md, unsigned type)
{
	md->type = type;
}
unsigned nolock_dm_get_md_type(struct mapped_device *md)
{
	return md->type;
}
#endif
...
{
#ifdef 	TUYA_CRYPTFS_SELECT
	unsigned md_type = nolock_dm_get_md_type(md);
#else
...
int dm_setup_md_queue(struct mapped_device *md)
{
	int r;
#ifdef 	TUYA_CRYPTFS_SELECT
	unsigned md_type = filter_md_type(nolock_dm_get_md_type(md), md);
#else
