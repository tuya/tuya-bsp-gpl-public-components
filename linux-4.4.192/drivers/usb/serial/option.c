...
static const struct usb_device_id option_ids[] = {
	...
	{ USB_DEVICE(0x1782, 0x4e00) },  /* add luat Air724UG  4g module */
			...
			const struct usb_device_id *id)
{
	...
	if (dev_desc->idVendor == cpu_to_le16(SAMSUNG_VENDOR_ID) &&
		...
		return -ENODEV;
	/* Quectel EC200T interface can be used as USB Network device */
  ...
  if (serial->dev->descriptor.idVendor == cpu_to_le16(0x2c7c) && 
      ...
      return -ENODEV;
	/* Luat air724UG interface can be used as USB Network device */
  if (serial->dev->descriptor.idVendor == cpu_to_le16(0x1782) && 
      serial->dev->descriptor.idProduct == cpu_to_le16(0x4e00) &&
      serial->interface->cur_altsetting->desc.bInterfaceNumber <= 1)
		return -ENODEV;
  	/* notion  air720 4g interface can be used as USB Network device */
  if (serial->dev->descriptor.idVendor == cpu_to_le16(0x1286) && 
      serial->dev->descriptor.idProduct == cpu_to_le16(0x4e3d) &&
      serial->interface->cur_altsetting->desc.bInterfaceNumber <= 1)
		return -ENODEV;
