...
#define NVRAM_HEADER_LOAD_ADDR ((unsigned char *)0x83000000)
#define NVRAM_VALUE_LOAD_ADDR  ((unsigned char *)0x83100000)
#define NVRAM_COMMIT_ADDR      ((unsigned char *)0x83200000)
...
int nvram_get(const char *name, char *value)
{
	...
	//printf("sjm:%s:%d %s=%d\n",__func__,__LINE__,name,enc_val);
