...
enum fdt_compat_id {
	COMPAT_UNKNOWN,
	COMPAT_ANYKA_H3D_LCD,		/* cdh add: Anyka H3D Display controller */
	COMPAT_ANYKA_H3D_MCI0,		/* cdh add: Anyka H3D Display controller */
	COMPAT_ANYKA_H3D_MCI1,		/* cdh add: Anyka H3D Display controller */
	COMPAT_ANYKA_H3D_MCI2,		/* cdh add: Anyka H3D Display controller */
	COMPAT_ANYKA_H3D_ETH,
	COMPAT_ANYKA_H3D_ETH1,
