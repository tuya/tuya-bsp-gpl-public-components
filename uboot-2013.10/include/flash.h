...
typedef struct {
	...
	struct spinand_flash *spi_nand_flash;
	int (*spinand_read)(struct spinand_flash *spi_nand_flash, u32 offset, size_t len, void *buf,  void *oob, size_t oob_len);
	int (*spinand_write)(struct spinand_flash *spi_nand_flash, u32 offset, size_t len,const void *buf,  const void *oob, size_t oob_len);
	int (*spinand_erase)(struct spinand_flash *spi_nand_flash, u32 offset, size_t len);
...
extern unsigned long spinand_flash_init (void);
